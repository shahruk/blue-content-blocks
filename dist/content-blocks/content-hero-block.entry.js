...
const ContentHeroBlock = class {
  ...
  render() {
    return (h("content-block-wrapper", { name: "content-hero-block", "extra-classes": this.activeClasses, backgroundClasses: this.computedBackgroundClasses(), background: this.background }, this.hasMedia &&
      h("div", { class: "content-hero-block__media" }, h("div", { class: "content-hero-block__media-wrapper" }, h("slot", { name: "media" }))), h("div", { class: this.computedContentClasses() }, h("slot", { name: "content" }), h("slot", null))));
  }
  get hostElement() { return getElement(this); }
};
ContentHeroBlock.style = contentHeroBlockCss;

export { ContentHeroBlock as content_hero_block };
