...
const ContentCarousel = class {
  ...
  componentDidLoad() {
    if (this.initMethod === 'load') {
      ...
      if (this.swiperOptions) {
        ...
        console.log(this.swiperOptions);
        console.log(JSON.parse(this.swiperOptions || ''));
      }
      this.initSwiper();
    }
  ...
  render() {
    return (h("content-block-wrapper", { name: "content-carousel", "background-mobile": this.mobileBackground, background: this.background }, h("div", { class: "content-carousel__content" }, h("div", { class: "swiper-container", ref: el => this.swiperContainer = el }, h("div", { class: "swiper-wrapper", ref: el => this.swiperWrapper = el }, h("slot", null)), h("div", { class: "swiper-pagination", ref: el => this.swiperPagination = el }), h("div", { class: "swiper-button-prev", ref: el => this.swiperPrevElement = el }), h("div", { class: "swiper-button-next", ref: el => this.swiperNextElement = el }), h("div", { class: "swiper-scrollbar", ref: el => this.swiperScrollbar = el })))));
  }
  get el() { return getElement(this); }
};
ContentCarousel.style = contentCarouselCss;

export { ContentCarousel as content_carousel };
